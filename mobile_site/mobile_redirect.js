/* Mobile redirect with View Full Site Capabilities  */
...
var mobilesite = "http://www.jason-storey.com/mobile_site/";
 
var locationhref = removeQueryString(location.href);
 
//alert("location href after: " + locationhref);
 
if (locationhref == "http://www.jason-storey.com/test-page.html") {
 
mobilesite = "http://www.jason-storey.com/mobile_site/index.html";
...
document.cookie = curName + "=" + escape(window.location.href) + "[#]contentid=" + document.getElementById("inputContentID").value + "[#]title=" + GetPageTitle() + ";expires=" + exdate.toGMTString() + ";path=/;domain=jason-storey.com;";
