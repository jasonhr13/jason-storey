...
var mobilesite = "http://www.callpreet.com/mobile/";
 
var locationhref = removeQueryString(location.href);
 
//alert("location href after: " + locationhref);
 
if (locationhref == "http://www.callpreet.com") {
 
mobilesite = "http://www.callpreet.com/mobile/index.html";
...
document.cookie = curName + "=" + escape(window.location.href) + "[#]contentid=" + document.getElementById("inputContentID").value + "[#]title=" + GetPageTitle() + ";expires=" + exdate.toGMTString() + ";path=/;domain=callpreet.com;";
